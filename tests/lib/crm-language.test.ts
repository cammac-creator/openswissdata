...
describe('Langue réelle, préférence et repli', () => {
 ...
 it('reconnaît le français d’un mail technique malgré les noms de produits',()=>{expect(detectLanguage('Votre dataset FINMA Registry — Unified est prêt. Merci pour votre achat ! Téléchargez votre fichier. Votre lien est valable pendant sept jours. Vous pouvez accéder aux mises à jour depuis votre compte. openswissdata.com est un service privé indépendant. Non affilié à opendata.swiss, BAZG, BFS, FINMA.').code).toBe('fr')});
