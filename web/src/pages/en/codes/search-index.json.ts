/**
 * GET /en/codes/search-index.json — NOGA search index (EN labels).
 */
...
export const GET: APIRoute = () => {
  const searchIndex = loadNoga2025()
    ...
    .map((r) => ({ code: r.code, label: r.label_en || r.label_fr, dotted: dottedCode(r.code), href: `/en/codes/noga/${r.code}` }));
