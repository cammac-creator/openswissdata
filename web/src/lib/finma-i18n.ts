...
export const FINMA_STR: Record<Lang, FinmaStrings> = {
  fr: {
    ...
    idxMetaTitle: "Répertoire FINMA — fiches et sources | openswissdata.com",
    idxMetaDesc: "Copie historique de listes FINMA. Recherche par nom ou catégorie et liens vers les sources officielles pour vérifier le statut actuel.",
  ...
  de: {
    ...
    idxMetaTitle: "FINMA-Verzeichnis — Einträge und Quellen | openswissdata.com",
    idxMetaDesc: "Historische Kopie von FINMA-Listen. Suche nach Name oder Kategorie und offizielle Quellen zur Prüfung des aktuellen Status.",
  ...
  en: {
    ...
    idxMetaTitle: "FINMA directory — entries and sources | openswissdata.com",
    idxMetaDesc: "Historical copy of FINMA lists. Search by name or category and use the official sources to check current status.",
