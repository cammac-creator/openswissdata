...
| `u9837718348_un_carr_qui_se_divise_en_4_plus_petits_qui_se_div_dcaf56bb-0012-42d7-b82c-e9139dfb0e40_0.png` | Bannière FINMA (subdivision récursive, carré rouge centré) — réutilisée pour FINMA après avoir été éphémère sur Classifications, validée 2026-05-06 | `/og-finma.png` (redimensionnée 1200×630), fond du hero `/datasets/finma` |
